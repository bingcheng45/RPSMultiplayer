                      ...
                      setState(() {
                        ...
                        if (gameOverMap != null) {
                          ...
                          if (move == gameOverMap["which"]) {
                            ...
                            print(
                                "scores match you own ${yourScore} ${opponentScore}");
                            isYourTurn = false;
                          } else {
                            opponentScore = opponentScore + 1;
                            yourScore = yourScore;
                            print(
                                "scores match lost ${yourScore} ${opponentScore}");
                            haveYouLost = true;
                          ...
                          haveYouLost = false;
                          print(
                              "scores not game over/reset ${yourScore} ${opponentScore}");
                          yourScore = yourScore;
                          opponentScore = opponentScore;
                        }
                      });
